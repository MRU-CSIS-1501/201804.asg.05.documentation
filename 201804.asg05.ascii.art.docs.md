...
>
> Finally, we choose to save the ascii art as a hex color file. This creates the file **bat.hex** in the **generated-hexcolor-files** directory. You can look at the file in this repo.
